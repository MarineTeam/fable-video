...
const OPTIONAL_PLAIN = [
  ...
  ["SITE_NAME", "starting portal name (admin-overridable in Settings)", 'defaults to "Marine Video Portal"'],
  ["NEXT_PUBLIC_SITE_NAME", "alternative spelling of SITE_NAME (client-bundled)", "SITE_NAME wins if both are set"],
