...
// one search, not four.
//
// PURE — no imports. Bundled into the homepage through lib/notes.js, like
// lib/scripture.js, so the same rule applies: no regex lookbehind (a
// parse-time SyntaxError in Safari before 16.4 would take the page down).
//
