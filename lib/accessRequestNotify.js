...
//     viewers-manage capability (CAP.VIEWERS_MANAGE) plus the ADMIN_EMAILS
//     owners, who hold the whole catalog by definition. Deriving it from the
//     capability rather than hardcoding "admins" matters more now that roles
//     are admin-defined: whoever an owner trusted with viewer management is
//     exactly who should hear about a request, whatever their role is called.
...
import { CAP, emailsHoldingCapability } from "./roles";
