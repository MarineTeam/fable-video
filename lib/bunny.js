...
//     (lib/chapters.js), typed by an admin and stored in lib/videoMeta.js.
//     Two writers for one concept is how hand-written chapters get silently
//     replaced. AI chapters belong behind an explicit "accept" action, not a
//     background write.
//
...
export async function transcribeVideo(id, { sourceLanguage, targetLanguages = [], force = false } = {}) {
